...
const MainIndexPage = () => {
  ...
  return (
    ...
    //       {/* Message Feed Panel */}
    //       <div className="h-full flex-1 overflow-hidden hover:overflow-y-auto rounded-2xl bg-white shadow-md p-4 md:p-6">
    //         {/* @ts-expect-error-null */}
    //         <MessageFeed user={user} />
    //       </div>

    //       {/* Filters Sidebar */}
    //       <aside className="h-full w-full md:max-w-sm overflow-hidden hover:overflow-y-auto rounded-2xl bg-white shadow-md p-4 md:p-6">
    //         <FiltersSidebar />
    //       </aside>
    //     </div>
    //   </section>
