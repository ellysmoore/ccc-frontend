  ...
  return (
    <>
      <div className="flex h-full flex-col md:flex-row gap-[12px]">
        <div className="h-full overflow-y-auto border-1 border-gray-200 shadow-md rounded-2xl w-full md:w-2/3 py-6 md:py-[15px] px-[20px] md:px-[25px]">
        ...
        <div className="h-full overflow-y-auto border-1 border-gray-200 shadow-md rounded-2xl w-full md:w-1/3 py-[12px] md:py-[15px] px-[20px] md:px-[25px]">
