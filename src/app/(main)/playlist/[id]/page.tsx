  ...
  return (
    <>
      <div className="flex h-full flex-col md:flex-row gap-[12px]">
        {/* Main Content */}
        <div className="h-full group overflow-hidden hover:overflow-y-auto border-2 border-[#F4F7F8] shadow-md rounded-2xl w-full py-[12px] md:py-[15px] px-[20px] md:px-[25px] md:w-3/4 flex flex-col gap-6">
        ...
        {/* Sidebar */}
        <div className="h-full group overflow-hidden hover:overflow-y-auto border-1 border-gray-200 shadow-md rounded-2xl w-full py-[12px] md:py-[15px] px-[12px] md:px-[15px] md:w-1/4 flex flex-col gap-6">
          <SermonSection
            title={
