  ...
  return (
    <>
      ...
      <div className="flex h-full flex-col md:flex-row gap-[12px]">
        {/* Main Content */}
        <div className="h-full overflow-y-auto rounded-[10px] bg-white w-full pt-[12px] md:pt-[15px] px-[20px] md:px-[25px] md:w-3/4 flex flex-col gap-6 shadow-md border-t border-gray-200">
        ...
        {/* Sidebar */}
        <div className="h-full overflow-y-auto rounded-xl border border-t border-gray-200 bg-white shadow-md w-full py-4 px-4 md:py-5 md:px-5 md:w-1/4 flex flex-col gap-6">
          <SermonSection
            title={
