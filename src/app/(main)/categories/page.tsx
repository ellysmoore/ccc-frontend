...
const CategoriesIndexPage = () => {
  ...
  return (
    <div className="flex h-full flex-col md:flex-row gap-[12px] mb-2">
      <div className="h-full gap-6 flex flex-col group overflow-hidden hover:overflow-y-auto  border-1 border-gray-200 shadow-md rounded-2xl w-full md:w-1/3 py-[12px] md:py-[15px] px-[12px] md:px-[15px]">
        <SermonSection
          title={
      ...
      <div className="h-full group overflow-hidden hover:overflow-y-auto border-1 border-gray-200 shadow-md rounded-2xl w-full md:w-2/3 py-[12px] md:py-[15px] px-[20px] md:px-[25px]">
