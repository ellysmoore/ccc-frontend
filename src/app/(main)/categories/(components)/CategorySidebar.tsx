...
export const CategorySidebar = ({ 
  ...
  return (
    <div className="h-full w-full md:w-1/3 flex flex-col gap-6 overflow-y-auto border-1 border-gray-200 shadow-md rounded-2xl bg-white px-4 py-4 md:px-5 md:py-5">
